...
- (void)launchApp:(NSString *)appId params:(NSDictionary *)params success:(AppLaunchSuccessBlock)success failure:(FailureBlock)failure; // Этот метод реализован только у Roku
