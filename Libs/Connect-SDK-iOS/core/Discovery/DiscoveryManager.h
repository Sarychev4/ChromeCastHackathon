...
typedef void (^DiscoveryManagerPingingBlock)(BOOL alive);
 ...
 */
@interface DiscoveryManager : NSObject <ConnectableDeviceDelegate, DiscoveryProviderDelegate>
