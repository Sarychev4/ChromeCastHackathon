...
extension CMSampleBuffer {
    ...
    var cgOrientation: CGImagePropertyOrientation {
        guard let orientationAttachment = CMGetAttachment(self, key: RPVideoSampleOrientationKey as CFString, attachmentModeOut: nil) as? NSNumber,
              let orientation = CGImagePropertyOrientation(rawValue: orientationAttachment.uint32Value)  else { return .up }
        return orientation
    }
}
